SMODS.Joker {
    ...
    calculate = function(self, card, context)
        ...
        if context.individual and context.cardarea == G.play then
            if not SMODS.has_enhancement(context.other_card, 'm_wild') then
               return
            end
        ...
        if context.destroying_card and SMODS.has_enhancement(context.destroying_card, 'm_wild') and not context.blueprint then
